					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>添加广告</div>
							</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form id="adForm" action="/Express/advertisement/save.do" class="form-horizontal" method="post" enctype="multipart/form-data" target="hidden_frame">
