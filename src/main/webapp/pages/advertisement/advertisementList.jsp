					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>广告列表</div>
							</div>
						<div class="portlet-body">
							<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
								...
								<tbody>
									<c:forEach  items="${advertisementList}"  var="item"  varStatus="status">
										<tr class="">
											<td>${status.index+1 }</td>
											<td>
												<div class="fileupload-new thumbnail" style="width: 150px; height: 200px;">
													<img src="/epUpload${item.pic}" alt="" style="width: 150px; height: 200px;" />
												</div>
											</td>
											<td><a  href="/Express/advertisement/view.do?id=${item.id}">View</a></td>
											<td><a  href="javascript:deleteAdvertisement('${item.id}')">Delete</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
	...
	<script>
		jQuery(document).ready(function() {       
	  	...
	  	function deleteAdvertisement(id){
            ...
            var url="/Express/advertisement/delAdvertisement.do";
