					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>广告详情</div>
							</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form id="adForm" action="/Express/advertisement/update.do" class="form-horizontal" method="post" enctype="multipart/form-data" target="hidden_frame">
								<input name="id" type="hidden" value="${add.id}">
								<input name="pic" type="hidden" value="${add.pic}">
									...
									<div class="controls">
										<div class="fileupload fileupload-new" data-provides="fileupload">
											<div class="fileupload-new thumbnail" style="width: 150px; height: 200px;">
												<img src="/epUpload${add.pic}" alt="" style="width: 150px; height: 200px;" />
											</div>
											<div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
											<div>
												<span class="btn btn-file"><span class="fileupload-new">更改图片</span>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span6 m-wrap" name="link" value="${add.link}" />
